...
// 2 is double-sampling and we only return valid data if both points dist < mstk
// 3+ uses insert sort to get the median value.
// We found 2 is precise yet not too slow so we suggest sticking with it!

#define NUMSAMPLES 2

#define mstk  2 // only for NUMSAMPLES = 2
// mstk
// 0..........................................1024
// more exect touch  --------> more max Line speed
// recommend: 0...6
...
TSPoint TouchScreen::getPoint(void) {
  ...
  *portOutputRegister(xm_port) &= ~xm_pin;
  ...
  if (abs(samples[0] - samples[1]) > mstk) {
    valid = 0;
  }
#endif
